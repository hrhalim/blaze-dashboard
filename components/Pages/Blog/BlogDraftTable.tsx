     ...
     <div className="bg-nt130 rounded-[20px] p-6 md:p-7.5 relative mb-6">
      <div className="flex items-center justify-between gap-3 flex-wrap mb-7.5">
        ...
        <div className="flex items-center flex-wrap gap-2 sm:gap-4">
          <Link href="/blog-draft" className="btngrdnt"><span className="py-2 sm:py-3 px-4 btngrdnt-child d-center gap-2">Draft  <i className="text-[#ffffff] ph ph-check"></i></span></Link>
