...
const statusStyle: Record<string, string> = {
  ...
  Resendinactive: "text-nt140 bg-[#1A9BFC3D]",
  Resend: "text-nt140 bg-[#1A9BFC3D]",
};

export default function PendingPartnerRequest() {
  return (
    <div className="bg-nt130 rounded-[20px] p-6 md:p-7.5 relative mb-6">
      ...
      <div className="flex items-center justify-between gap-3 flex-wrap mb-7.5">
        <div>
          <h4 className="text-nt18 mb-1">Pending Partner Request</h4>
          <span className="text-[13px] text-nt160">
            Total Pending Request: 05
          </span>
        </div>
